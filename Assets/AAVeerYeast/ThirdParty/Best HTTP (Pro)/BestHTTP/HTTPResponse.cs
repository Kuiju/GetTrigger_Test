...
namespace BestHTTP
{
    ...
    public class HTTPResponse : IDisposable
    {
        ...
        /// <summary>
        /// The data loaded to a Texture2D with format RGB24.
        /// </summary>
        public Texture2D DataAsTexture2DWithRBG24
        {
            get
            {
                if (Data == null)
        ...
        {
            lock (SyncRoot)
                return streamedFragments != null && streamedFragments.Count > 0 && !disposed;
        }
        ...
        // Fix the bug of when using Streaming request.Abort() won't free the connection
        bool disposed = false;
